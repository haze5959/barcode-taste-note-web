          ...
          <div className="flex flex-col gap-6">
            ...
            >
              ...
              <div className="absolute top-4 left-4 right-4 z-20 flex justify-between">
                <InfoTagView text={
                  info.note.publicScope === 2 ? t('note.public_scope_public') :
                    info.note.publicScope === 1 ? t('note.public_scope_friends', { defaultValue: '친구 공개' }) :
                      t('note.public_scope_private')
                } />
                          ...
                          <div className="flex-1 flex gap-1 ml-2">
                            {[1, 2, 3, 4, 5].map(step => {
                              ...
                              return (
                                <div
                                  key={step}
                                  className={`h-2.5 flex-1 rounded-sm ${step <= value
